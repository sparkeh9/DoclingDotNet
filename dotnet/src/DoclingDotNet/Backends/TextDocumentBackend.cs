...
public sealed class TextDocumentBackend : IDocumentBackend
{
    public string Name => "text_backend";
    public IReadOnlyList<string> SupportedExtensions { get; } = [".txt", ".log", ".ini"];
