...
public sealed class XmlDocumentBackend : IDocumentBackend
{
    public string Name => "xml_backend";
    public IReadOnlyList<string> SupportedExtensions { get; } = [".xml", ".jats", ".mets"];
